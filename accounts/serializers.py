...
class PolicySerializer(serializers.ModelSerializer):
    user=SimpleStoreSerializer
    class Meta:
        model = StoreProfile
        fields = ['user','supplier','return_policy']

class PolicyStoreSerializer(serializers.ModelSerializer):
    store_profile=PolicySerializer()
    class Meta:
        model = Store
        fields =['id','username','store_profile']
