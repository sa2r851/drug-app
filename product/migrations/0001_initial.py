    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cartitems', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='order', to='product.cartitems')),
            ],
        ),
        migrations.CreateModel(
            name='Offer',
        ...
        migrations.AddField(
            ...
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='carditems', to='product.offer'),
        ),
    ]
